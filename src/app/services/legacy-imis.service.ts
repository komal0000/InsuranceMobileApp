...
export class LegacyImisService {
  ...
  private kycEditableFields(payload: LegacyImisKycEditableFields): LegacyImisKycEditableFields {
    return this.withoutUndefined({
      ...
      f_first_name_loc: payload.f_first_name_loc,
      f_last_name_loc: payload.f_last_name_loc,
      m_first_name_loc: payload.m_first_name_loc,
      m_last_name_loc: payload.m_last_name_loc,
      gf_first_name_loc: payload.gf_first_name_loc,
      gf_last_name_loc: payload.gf_last_name_loc,
      f_first_name_en: payload.f_first_name_en,
      f_last_name_en: payload.f_last_name_en,
      m_first_name_en: payload.m_first_name_en,
      m_last_name_en: payload.m_last_name_en,
      gf_first_name_en: payload.gf_first_name_en,
      gf_last_name_en: payload.gf_last_name_en,
      birth_certificate: payload.birth_certificate,
      photo: payload.photo,
    });
  }
